package com.cqbo.web.infrastructure.manager;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.NumberUtil;
import cn.hutool.core.util.RandomUtil;
import com.cqbo.web.infrastructure.api.MinioApi;
import com.cqbo.web.infrastructure.config.MinioClientConfig;
...
import com.cqbo.web.infrastructure.manager.upload.model.dto.file.UploadPictureResult;
...
//            // 计算宽高
            ...
            uploadPictureResult.setUrl(minioClientConfig.getHost() + "/" + minioClientConfig.getBucket() + uploadPath);
    ...
    public void deleteTempFile(File file) {
        ...
        if (!deleteResult) {
            logger.error("file delete error, filepath = {}", file.getAbsolutePath());
        }
    }
}
